...
class ModelWrapper(nn.Module):
    ...
    def compute_cross_T(
        ...
        return logits_cross, frame_contrib, l_lin_enc_x_i_heads
    ...
    def get_logit_contributions(self, hidden_states, attentions, token, full_vocab=False, output_pos=-1, encoder_hidden_states=None, cross_attentions=None):
        ...
        logits_modules["l_lin_enc_x_i_heads"] = []
        ...
        for layer in range(0,self.num_layers):
            ...
            logits_cross, frame_contrib, l_lin_enc_x_i_heads = self.compute_cross_T(
            ...
            logits_modules["l_lin_enc_x_i_heads"].append(l_lin_enc_x_i_heads)
